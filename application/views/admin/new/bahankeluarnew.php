...
<h5> <strong>Silahkan Isi Data Bahan Kelaur Dibawah Ini</strong></h5>
</li>
</ol>


<form method="POST" action="<?php echo site_url('admin/cbahan_keluar/add') ?>" enctype="multipart/form-data" class="col-md-12">
<div class="row">
<div class="col-md-6">
...
<input value="" required="required" type="text" class="form-control" name="lokasi_tujuan">                   
</div>

<div class="form-group">
<label for="tanggal keluar">Tanggal Keluar</label>
<input required="required" type="date" class="form-control" name="tanggal_keluar">              
</div>
</div>
</div>
</div>
