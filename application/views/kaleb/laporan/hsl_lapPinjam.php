...
<div  class="card-footer small text-muted text-center"><a href="<?php echo base_url('kaleb/laporan/cetaklapPinjam') ?>">
...
<div  class="card-footer small text-muted text-center"><a href="<?php echo base_url('kaleb/laporan/Peminjaman') ?>">
