...
<head>
  ...
  <link href="assets/template/css/business-casual.css" rel="stylesheet">
...
<body>
  ...
  <h1 class="site-heading text-center text-white d-none d-lg-block">
    <span class="site-heading-upper text-primary mb-3"><img src="<?php echo base_url()?>/assets/img/Polije.png" style="width:50px;height:50px;"> Sistem Informasi Inventori Laboratorium Rekayasa Perangkat Lunak </span>
