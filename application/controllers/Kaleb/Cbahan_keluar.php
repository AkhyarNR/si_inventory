...
class Cbahan_keluar extends CI_Controller {
    ...
    public function index(){
      ...
      $this->load->view("kaleb/vbahan_keluar", $data);
    }


    public function tambah(){
        $this->load->view('kaleb/new/bahankeluarnew');
    }
     ...
     public function add() {
        ...
        redirect(base_url('kaleb/cbahan_keluar'));
    }

    public function edit($id){
      $where = array('id_bahankeluar' => $id);
      $data['tb_bahankeluar']   = $this->m_bahankeluar->edit_data($id);
      $this->load->view('kaleb/edit/bahan_keluaredit',$data);
    }
    ...
    public function update(){
     ...
     redirect('kaleb/cbahan_keluar/index');
    ...
    public function delete($id=null) {
      ...
      if ($this->m_bahankeluar->delete($id)) {
         redirect(site_url('kaleb/cbahan_keluar'));
    }
    }
